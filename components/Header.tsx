    ...
    <header className="bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 h-16 sticky top-0 z-30 shadow-sm transition-colors duration-300">
      <div className="max-w-6xl mx-auto h-full px-4 relative flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 z-10">
          ...
          <h1 className="text-xl font-bold text-emerald-800 dark:text-emerald-500 hidden md:block">Open Quran Reader</h1>
        </div>
            ...
            <div className="relative">
                ...
                >
                  <span className="font-semibold">
                    {currentChapter ? `${currentChapter.id}. ${currentChapter.name_simple}` : 'Select Surah'}
                  </span>
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-[10px] text-slate-400">{chapter.translated_name.name}</span>
                            </div>
                          </div>
                          <span className="font-vazir text-slate-400 dark:text-slate-600">{chapter.name_arabic}</span>
                        </button>
                      ))}
                    </div>
                  </div>
